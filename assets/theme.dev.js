...
* Custom Store Theme
*
* This file is included for advanced development.
* Modified versions of the theme code may require
* custom maintenance and support.
*
    ...
    */
    ...
    class CartItems extends HTMLElement {
      ...
      connectedCallback() {
        ...
        // Set global event listeners for "In winkelwagen toevoegen" and Announcement bar wheel progress
        ...
        fetch(theme.routes.cart_add_url, {
          ...
          .then((response) => {
            ...
            if (this.cart) {
              ...
              // Redirect to cart page if "In winkelwagen toevoegen" is successful
              window.location = theme.routes.cart_url;
            }
          })
          .catch((error) => {
      ...
      /**
       * In winkelwagen toevoegen error handle
       *
       * @param   {Object}  data
